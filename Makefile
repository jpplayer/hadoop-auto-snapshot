...
install:
	...
	install -m 644 etc/hdfs-auto-snapshot.cron.hourly   $(DESTDIR)$(PREFIX)/etc/cron.hourly/hdfs-auto-snapshot
	install -m 644 etc/hdfs-auto-snapshot.cron.daily    $(DESTDIR)$(PREFIX)/etc/cron.daily/hdfs-auto-snapshot
	install -m 644 etc/hdfs-auto-snapshot.cron.weekly   $(DESTDIR)$(PREFIX)/etc/cron.weekly/hdfs-auto-snapshot
	install -m 644 etc/hdfs-auto-snapshot.cron.monthly  $(DESTDIR)$(PREFIX)/etc/cron.monthly/hdfs-auto-snapshot
